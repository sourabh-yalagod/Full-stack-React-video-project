...
const Comments = ({ apiResponse, videoId }: any) => {
  ...
  return (
    <ScrollArea className="w-full text-white overflow-scroll pb-10 grid place-items-center max-h-56 rounded-xl p-1 border-slate-500 border-[1px] md:max-h-96 lg:h-auto">
